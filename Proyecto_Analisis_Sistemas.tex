...
% Definición del símbolo de colón costarricense
\newcommand{\coloncrc}{\textsf{C}\hspace{-0.78em}\raisebox{0.08ex}{--}\hspace{-0.3em}\raisebox{0.58ex}{--}\:\!}
...
\begin{xltabular}{\textwidth}{|X|>{\centering\arraybackslash}p{1.2cm}|>{\centering\arraybackslash}p{2.8cm}|>{\centering\arraybackslash}p{3.2cm}|}
\hline
\rowcolor{gray!20}
\textbf{Actividad} & \textbf{Horas} & \textbf{Costo por hora} & \textbf{Subtotal} \\
\hline
\endhead
Análisis del negocio y requisitos & 100 & \coloncrc\ 12 000,00 & \coloncrc\ 1 200 000,00 \\ \hline
Diseño de la base de datos & 140 & \coloncrc\ 12 000,00 & \coloncrc\ 1 680 000,00 \\ \hline
Diseño de arquitectura & 80 & \coloncrc\ 12 000,00 & \coloncrc\ 960 000,00 \\ \hline
Diagramas UML & 70 & \coloncrc\ 12 000,00 & \coloncrc\ 840 000,00 \\ \hline
Planificación SCRUM y documentación & 110 & \coloncrc\ 12 000,00 & \coloncrc\ 1 320 000,00 \\ \hline
Diseño integración Tableau & 100 & \coloncrc\ 12 000,00 & \coloncrc\ 1 200 000,00 \\ \hline
\textbf{TOTAL} & \textbf{600} & & \textbf{\coloncrc\ 7 200 000,00} \\ \hline
\caption{Presupuesto}
\end{xltabular}
...
% Reemplazar por: 
\includegraphics[width=0.9\textwidth]{figura2_casos_uso.png}{Figura 2. Primer diagrama de casos de uso del sistema}
...
\includegraphics[width=0.9\textwidth]{figura7_mockups_interfaz.png}
...
\includegraphics[width=0.9\textwidth]{figura8_captura_prototipo.png}
