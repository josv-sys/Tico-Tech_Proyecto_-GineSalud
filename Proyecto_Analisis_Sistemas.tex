...
preparada para su integración con Tableau, permitiendo la generación de reportes,
indicadores y paneles de control que apoyen el análisis de la información en tiempo real.
...
\begin{longtable}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
\hline
\rowcolor{gray!20}
...
\begin{longtable}{|p{2cm}|p{1.7cm}|p{1.6cm}|p{1.6cm}|p{1.1cm}|p{1.6cm}|p{1.3cm}|p{1.8cm}|}
\hline
\rowcolor{gray!20}
\textbf{Nombre de la tarea} & \textbf{Asignada a} & \textbf{Fecha de inicio} & \textbf{Fecha de finalización} & \textbf{Duración (días)} & \textbf{Estado} & \textbf{Prioridad} & \textbf{Comentarios} \\
\hline
\endhead
...
\hline
\endhead
Análisis del negocio y requisitos & 100 & \textcolor{black}{\textcurrency} 12 000,00 & \textcolor{black}{\textcurrency} 1 200 000,00 \\ \hline
Diseño de la base de datos & 140 & \textcolor{black}{\textcurrency} 12 000,00 & \textcolor{black}{\textcurrency} 1 680 000,00 \\ \hline
Diseño de arquitectura & 80 & \textcolor{black}{\textcurrency} 12 000,00 & \textcolor{black}{\textcurrency} 960 000,00 \\ \hline
Diagramas UML & 70 & \textcolor{black}{\textcurrency} 12 000,00 & \textcolor{black}{\textcurrency} 840 000,00 \\ \hline
Planificación SCRUM y documentación & 110 & \textcolor{black}{\textcurrency} 12 000,00 & \textcolor{black}{\textcurrency} 1 320 000,00 \\ \hline
Diseño integración Tableau & 100 & \textcolor{black}{\textcurrency} 12 000,00 & \textcolor{black}{\textcurrency} 1 200 000,00 \\ \hline
\textbf{TOTAL} & \textbf{600} & & \textbf{\textcurrency\ 7 200 000,00} \\ \hline
\caption{Presupuesto}
\end{longtable}
...
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura1_arquitectura.png}
\placeholderimg{12}{7}{Figura 1. Propuesta minimalista de la Arquitectura del Sistema}
...
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura2_casos_uso.png}
\placeholderimg{12}{9}{Figura 2. Primer diagrama de casos de uso del sistema}
...
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura3_diagrama_actividad.png}
\placeholderimg{12}{8}{Figura 3. Diagrama de actividad -- Registrar y confirmar cita médica}
...
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura4_diagrama_clases.png}
\placeholderimg{12}{8}{Figura 4. Diagrama de clases del sistema GineSalud}
...
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura5_diagrama_despliegue.png}
\placeholderimg{12}{8}{Figura 5. Diagrama de despliegue del sistema GineSalud}
...
\hline
\endhead
Análisis del negocio y requisitos & 100 & \textcurrency\ 12 000,00 & \textcurrency\ 1 200 000,00 \\ \hline
Diseño de la base de datos & 140 & \textcurrency\ 12 000,00 & \textcurrency\ 1 680 000,00 \\ \hline
Diseño de arquitectura & 80 & \textcurrency\ 12 000,00 & \textcurrency\ 960 000,00 \\ \hline
Diagramas UML & 70 & \textcurrency\ 12 000,00 & \textcurrency\ 840 000,00 \\ \hline
Planificación SCRUM y documentación & 110 & \textcurrency\ 12 000,00 & \textcurrency\ 1 320 000,00 \\ \hline
Diseño integración Tableau & 100 & \textcurrency\ 12 000,00 & \textcurrency\ 1 200 000,00 \\ \hline
Diseño integración Power BI / Power Apps & 40 & \textcurrency\ 12 000,00 & \textcurrency\ 480 000,00 \\ \hline
\textbf{TOTAL} & \textbf{640} & & \textbf{\textcurrency\ 7 680 000,00} \\ \hline
...
\begin{longtable}{|p{4.5cm}|p{1.3cm}|p{1.8cm}|p{2.3cm}|p{1.6cm}|}
\hline
\rowcolor{gray!20}
...
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura6_diagrama_red_gantt.png}
\placeholderimg{12}{7}{Figura 6. Diagrama de red / Gantt de la ruta crítica}
...
\begin{longtable}{|p{3.3cm}|p{1.5cm}|p{1.5cm}|p{3.2cm}|p{3.2cm}|}
\hline
\rowcolor{gray!20}
...
versionados en el repositorio del proyecto, en las carpetas \texttt{/sql} y \texttt{/bi}.
...
\begin{itemize}
    ...
    utilizadas como fuente de datos por Tableau y Power BI respectivamente (ver
    \texttt{bi/tableau/README.md} y \texttt{bi/powerbi/README.md}).
\end{itemize}
...
Se definieron los siguientes casos de prueba unitarios y de integración sobre el prototipo.
Los resultados obtenidos deberán completarse al ejecutar los scripts en un entorno
PostgreSQL real, siguiendo los pasos descritos en \texttt{prototipo/README.md}.

\begin{longtable}{|p{4cm}|p{1.6cm}|p{4cm}|p{3.4cm}|}
\hline
\rowcolor{gray!20}
...
dataset en Power BI) en lugar de conexión en vivo permanente, según lo documentado en los
README de \texttt{/bi}.
...
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura7_mockups_interfaz.png}
\placeholderimg{12}{7}{Figura 7. Mockups de las pantallas principales del sistema}

\subsubsection*{Evidencia del prototipo}

Las capturas de pantalla del prototipo (tablas creadas, dashboard de Tableau, reporte de
Power BI y formulario de Power Apps) y el video corto de demostración se incorporarán en
la carpeta \texttt{/prototipo} del repositorio, según el detalle pendiente listado en
\texttt{prototipo/README.md}.

% --- PLACEHOLDER FIGURA 8 ---
% Reemplazar por: \includegraphics[width=0.9\textwidth]{figura8_captura_prototipo.png}
\placeholderimg{12}{7}{Figura 8. Captura del prototipo funcional (base de datos y dashboards)}
